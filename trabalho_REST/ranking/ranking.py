...
def callback_voto(ch, method, properties, body):
    ...
    try:
        ...
        if(promocoes_aprovadas[index]['valor_voto'] >= THRESHOLD):
            ...
            promocoes_destaque.append(promocoes_aprovadas[index])
        ...
        elif promocoes_aprovadas[index]['valor_voto'] < THRESHOLD:
            promocoes_destaque = [promocao for promocao in promocoes_destaque if promocao['nome'] != promocoes_aprovadas[index]['nome']]
